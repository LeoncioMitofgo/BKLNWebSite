  ...
  return (
    <div className="min-h-screen pt-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Contenido */}
        <div className="prose prose-invert prose-blue max-w-none mb-12 prose-headings:text-text-primary prose-p:text-text-secondary prose-strong:text-text-primary prose-code:text-accent-blue prose-code:bg-bg-surface prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-pre:bg-bg-surface prose-pre:border prose-pre:border-white/10 prose-li:text-text-secondary prose-a:text-accent-blue prose-blockquote:border-brand-blue prose-blockquote:text-text-secondary">
