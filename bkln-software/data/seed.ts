...
export const courses: Course[] = [
  {
    ...
    description: 'Aprende Python de verdad: desde qué es una variable hasta proyectos reales con automatización e IA. Libro interactivo + videos + ejercicios.',
    longDescription:
      'Un curso completo de Python en español pensado para quien nunca ha programado. Nada de ejemplos de juguete — cada concepto se explica con situaciones reales y se practica con ejercicios que tienen sentido.\n\nEl curso se estructura en tres libros: Python básico, Python intermedio y Python avanzado. El primero ya está disponible en formato de libro interactivo con quizzes, modo oscuro y ajuste de fuente. Los videos explicativos y los libros 2 y 3 se irán publicando progresivamente.',
    category: 'python',
    price: 0,
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'l1-m8', title: 'Proyecto final básico', duration: 'próx.', isFree: true },
        ],
      },
      {
        id: 'l2',
        ...
        lessons: [
          { id: 'l2-m1', title: 'Diccionarios y conjuntos', duration: 'próx.', isFree: false },
          { id: 'l2-m2', title: 'Funciones avanzadas', duration: 'próx.', isFree: false },
          { id: 'l2-m3', title: 'Programación orientada a objetos', duration: 'próx.', isFree: false },
          { id: 'l2-m4', title: 'Manejo de errores', duration: 'próx.', isFree: false },
          { id: 'l2-m5', title: 'Archivos y datos', duration: 'próx.', isFree: false },
          { id: 'l2-m6', title: 'Módulos y paquetes', duration: 'próx.', isFree: false },
          { id: 'l2-m7', title: 'Comprensiones e iteradores', duration: 'próx.', isFree: false },
          { id: 'l2-m8', title: 'Proyecto final intermedio', duration: 'próx.', isFree: false },
        ],
      },
      {
        id: 'l3',
        ...
        duration: 'próximamente',
        lessons: [
          { id: 'l3-m1', title: 'Python y la web', duration: 'próx.', isFree: false },
          { id: 'l3-m2', title: 'Bases de datos', duration: 'próx.', isFree: false },
          { id: 'l3-m3', title: 'APIs y servicios externos', duration: 'próx.', isFree: false },
          { id: 'l3-m4', title: 'Análisis de datos', duration: 'próx.', isFree: false },
          { id: 'l3-m5', title: 'Automatización', duration: 'próx.', isFree: false },
          { id: 'l3-m6', title: 'Testing y calidad', duration: 'próx.', isFree: false },
          { id: 'l3-m7', title: 'Python profesional', duration: 'próx.', isFree: false },
          { id: 'l3-m8', title: 'Proyecto final avanzado', duration: 'próx.', isFree: false },
        ],
      },
    ],
    includes: [
      'Libro interactivo completo (Libro 1 disponible ya)',
      'Quizzes integrados por capítulo',
      'Modo oscuro, ajuste de fuente',
      'Videos explicativos (en producción)',
      'Libros 2 y 3 incluidos al publicarse',
      'Acceso de por vida',
    ],
  },
  {
